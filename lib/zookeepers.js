...
function filterByQuery(query, zookeepers) {
    ...
    if (query.age) {
        filteredResults = filteredResults.filter(
            // since the form data will be coming in as strings, & the json is storing age as a number
            //  the query string must be converted to a number to perform a comparison
